window.unit1PracticeBank = [
  ...
  },
  {
    ...
    "skill": "Compose a non-square parallelogram",
  ...
  },
  {
    ...
    "sourceItem": "Problem 1, parts a-b",
    ...
    "visualRules": {
      ...
      "notes": "Preserves both named source strategies with separate exact visual crops, separate app-styled choices, and separate feedback instead of collapsing them into one ungraded response."
    },
    "hints": [
  ...
  },
  {
    ...
    "activityForm": "validated error analysis",
    ...
    "missingFeedback": "Describe at least one mathematical error before submitting.",
    "correctFeedback": "Correct. Jada multiplied 3 × 4 for each triangular face but forgot the 1/2 factor. Each triangle has area 1/2 × 3 × 4 = 6 square centimeters, not 12.",
    "incorrectFeedback": "Not quite. Check the two right triangles labeled 12 sq cm. To pass this app check, explain that a triangle uses 1/2 × base × height, or state that each 12 should be 6.",
    "visualRules": {
      "status": "passes",
      "sourceActionTargets": 1,
      "appActionTargets": 1,
    ...
    "sampleAnswer": "Jada used 3 × 4 = 12 for each triangle but forgot to divide by 2. Each triangular face has area 6 square centimeters.",
    "implementationNotes": "Rebuilt from Lesson 15 cumulative-practice Problem 1b with the exact source net and task-specific validation for Jada's actual error.",
    "source": "Cumulative Practice Problems/Grade6-1-15-Lesson-curated-practice-problem-set.pdf p.1"
  },
  {
    "unit": "unit1",
    ...
    "activityForm": "short-answer net identification",
    ...
    "missingFeedback": "Name the polyhedron before submitting.",
    ...
    "correctFeedback": "Correct. The two congruent triangles become the bases, and the three rectangles wrap around their corresponding edges, so the net assembles into a triangular prism.",
    "incorrectFeedback": "Not quite. Identify the pair of congruent faces that become bases, then identify the faces that connect their matching edges.",
    "visualRules": {
      "status": "passes",
      "sourceActionTargets": 2,
      "appActionTargets": 2,
      "unitOfAction": "one typed polyhedron identification and one required explanation for source Problem 2a",
      "sourceObjects": [
        "exact gridded source net with two triangular faces and three rectangular faces"
      ],
      "notes": "Uses an exact visual-only crop of the source Problem 2 net. The app does not reveal the face inventory in the prompt and scopes this card explicitly to part 2a."
    },
    "hints": [
    ...
    "implementationNotes": "Rebuilt from Lesson 14 cumulative-practice Problem 2a with the exact gridded source net, a typed identification, and validated source-requested reasoning.",
